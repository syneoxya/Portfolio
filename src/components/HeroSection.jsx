  ...
  return (
    ...
    >
      <Motion.div
        ...
        className={
          darkMode
            ? "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.14),transparent_32%),radial-gradient(circle_at_82%_28%,rgba(249,115,22,0.12),transparent_24%),linear-gradient(180deg,transparent,rgba(2,6,23,0.14),transparent)]"
            : "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.05),transparent_28%),radial-gradient(circle_at_82%_28%,rgba(249,115,22,0.05),transparent_22%),linear-gradient(180deg,transparent,rgba(255,255,255,0.08),transparent)]"
        }
      />
      <Motion.div
        style={{ y: haloY }}
      ...
      <Motion.div
        ...
        className={
          darkMode
            ? "pointer-events-none absolute right-[-6rem] top-1/3 z-0 h-80 w-80 rounded-full bg-orange-400/10 blur-3xl"
            : "pointer-events-none absolute right-[-6rem] top-1/3 z-0 h-80 w-80 rounded-full bg-orange-300/8 blur-3xl"
        }
      />
